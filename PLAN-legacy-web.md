# Legacy plan: ForkIt web prototype (Next.js)

This file preserves the **completed milestone checklist** for the **archived** Next.js + PartyKit + Vercel web application. It is **not** the active roadmap.

**Current product and engineering direction** are defined in [`SPEC.md`](./SPEC.md) (mobile, offline-first) and tracked in [`PLAN.md`](./PLAN.md).
